...
//                 }
//             });
//             const initialQuantities = res.data.reduce((acc, product) => ({ ...acc, [product._id]: 1 }), {});
//             const initialSubtotals = res.data.reduce((acc, product) => {
//                 const price = parseFloat((product.discount_price === '$0' ? product.main_price : product.discount_price).replace(/[^0-9.-]+/g, ""));
...
//                 <div key={product._id} className="flex items-center justify-center border mx-32 mt-9 py-7 rounded shadow-md text-base poppins font-normal px-5">
//                     <div className="flex items-center gap-4 w-4/12 relative">
//                         <GiCancel onClick={() => handleDelete(product._id, product.product_title)} className="absolute text-xl text-red-500 bottom-7 left-9 cursor-pointer" />
//                         <img className="w-12 h-10" src={product.product_image} alt={product.product_title} />
//                         <span>{product.product_title}</span>
//                     </div>
//                     <p className="w-3/12">{product.discount_price === '$0' ? product.main_price : product.discount_price}</p>
...
//                             <div>
//                                 <IoIosArrowUp onClick={() => quantityPlus(product._id, quantities[product._id], product)} />
//                                 <IoIosArrowDown onClick={() => quantityMinus(product._id, quantities[product._id], product)} />
//                             </div>
//                         </div>
//                     </div>
...
//                 <div className="w-3/2">
//                     <input className="border-2 border-gray-400 rounded py-2.5 pr-10 pl-3" type="text" placeholder="Coupon Code" />
...
//                         <p>Total:</p><span>$1750</span>
//                     </div>
//                     <div className="flex justify-center">
//                         <button className="py-3 px-9 bg-[#DB4444] text-white rounded">Process to checkout</button>
//                     </div>
//                 </div>
//             </div>
//         </div>
