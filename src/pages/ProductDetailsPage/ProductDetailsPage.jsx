    ...
    return (
        <div>
            ...
            <div className="md:flex justify-center gap-20 md:mx-0 mx-2 py-24">
                ...
                <div>
                    <h2 className="text-[#000] dark:text-white font-semibold text-2xl">{product_title}</h2>
                    ...
                    <div className="border rounded border-[#000] mt-6">
                        <div className="flex items-center gap-3 py-3 px-4">
                            ...
                            <div><p className="text-[#000] dark:text-white poppins text-base font-medium">Free Delivery</p>
                            <p className="text-[12px] dark:text-white text-[#000] font-medium">Enter your postal code for Delivery Availability</p></div>
                        </div>
                        <hr className="border-[#000]"/>
                        <div className="flex items-center px-4 py-3 gap-3">
                            <GrPowerCycle className="text-3xl"/>
                            <div><p className="text-[#000] dark:text-white poppins text-base font-medium">Return Delivery</p>
                            <p className="text-[12px] text-[#000] dark:text-white font-medium">Free 30 Days Delivery Returns. Details</p></div>
                        </div>
                    </div>
                </div>
            </div>
