    ...
    return (
        <div className="py-20">
            <div className="border dark:border-white md:w-2/5 md:mx-auto mx-2 pt-5 pb-5 rounded-2xl px-10">
                ...
                <h2 className="text-[17px] font-medium text-gray-500 dark:text-white text-center">Your transaction has Canceled by you. <br /> <span className="text-[#121212] dark:text-white">Please try again</span></h2>
