    ...
    return (
        <div className="py-20">
            <div className="border w-2/5 mx-auto pt-5 pb-5 rounded-2xl px-10">
                ...
                <h3 className="text-center text-[#121212] poppins font-medium text-[30px]">Payment Failed</h3>
                <h2 className="text-[17px] font-medium text-gray-500 text-center">Your transaction has failed due to some technical error. <span className="text-[#121212]">Please try again</span></h2>
