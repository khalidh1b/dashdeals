        ...
        <div>
            ...
            <div className="flex gap-7 justify-center">
                <div className="bg-[#0D0D0D] rounded relative">
                    <img src="https://i.postimg.cc/XYQcGNFX/playstation-5.png" alt="playstation5" />
                ...
                <div>
                    <div className="relative rounded border pl-32 bg-[#0D0D0D]">
                        <img src="https://i.postimg.cc/zDVMqMsn/woman-wearing-hat.png" alt="woman-wearing-hat" />
                    ...
                    <div className="flex gap-7 pt-7">
                        <div className="w-1/2 py-7 rounded bg-[#0D0D0D] relative"><img className="mx-auto" src="https://i.postimg.cc/W4qFNswB/speakers.png" alt="speakers" />
                        ...
                        <div className="w-1/2 py-7 rounded bg-[#0D0D0D] relative"><img className="mx-auto" src="https://i.postimg.cc/gJPJG8Jh/perfume.png" alt="perfume" />
