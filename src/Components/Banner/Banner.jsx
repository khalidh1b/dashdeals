    ...
    return (
        <div className="flex justify-center gap-10 items-center">
            <div className="border-r px-5 pt-16">
                <ul className="grid gap-4 text-[#000] text-base poppins font-normal">
            ...
            <div className="mt-10 border">
                <div className="flex items-center gap-5 rounded bg-[#000] pl-14 py-5">
                    <div>
                        <div className="flex items-center gap-6"><img src="https://i.postimg.cc/Pf42qn0X/apple-logo.png" alt="logo" /><span className="text-[#FAFAFA] poppins text-base font-normal">iPhone 14 Series</span></div>
                    ...
                    <img src="https://i.postimg.cc/P503Yzt2/apple-banner-img.png" alt="banner" />
                </div>
            </div>
        </div>
    );
